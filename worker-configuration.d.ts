/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c015e7e0925356513512b4cd191bdbb7)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ALT_HEADER_NAME: "x-image-alt-desc";
		TEAM_DOMAIN: "goncalo2k03.cloudflareaccess.com";
		ALLOWED_ORIGINS: "https://staging.goncalo2k.pt/,https://staging.goncalo2k.com/";
		AUTH_ROUTES: "/images/audit";
		ENABLE_AUTH: true;
		LOG_LEVEL: "debug";
	...
	interface Env {
		...
		ALT_HEADER_NAME: "x-image-alt-desc";
		TEAM_DOMAIN: "goncalo2k03.cloudflareaccess.com";
		ALLOWED_ORIGINS: "https://staging.goncalo2k.pt/,https://staging.goncalo2k.com/" | "https://goncalo2k.pt/";
		AUTH_ROUTES: "/images/audit";
		ENABLE_AUTH: true;
		LOG_LEVEL: "debug";
		MAX_UPLOAD_SIZE_MB: 20;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALT_HEADER_NAME" | "TEAM_DOMAIN" | "ALLOWED_ORIGINS" | "AUTH_ROUTES" | "ENABLE_AUTH" | "LOG_LEVEL" | "MAX_UPLOAD_SIZE_MB" | "ENVIRONMENT" | "POLICY_UAD" | "POLICY_AUD">> {}
}
